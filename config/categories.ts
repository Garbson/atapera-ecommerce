...
export const categoriesConfig: Record<string, CategoryConfig> = {
  airsoft: {
    slug: 'airsoft',
    title: 'Airsoft',
    description: 'Equipamentos completos para Airsoft! Armas, munições, equipamentos táticos e acessórios para simulação militar e jogos esportivos.',
    color: 'green',
    warning: 'Equipamentos para uso esportivo e simulação. Sempre use equipamentos de proteção adequados.',
  ...
  'armas-fogo': {
    slug: 'armas-fogo',
    title: 'Armas de Fogo',
    description: 'Armas registradas com toda documentação necessária. Segurança e qualidade garantidas para colecionadores, atiradores e caçadores licenciados.',
    color: 'red',
    warning: 'Todos os produtos requerem registro no Exército e documentação válida (CR, CRAF ou Porte).',
  ...
  'armas-pressao': {
    ...
    description: 'Armas de pressão de alta qualidade para tiro esportivo, treinamento e controle de pragas. Carabinas e pistolas de ar comprimido.',
    color: 'blue',
    warning: 'Produtos para maiores de 18 anos. Uso responsável e com equipamentos de proteção.',
    warningTitle: 'Atenção',
    warningType: 'info',
    filters: [
      {
  ...
  pesca: {
    slug: 'pesca',
    title: 'Pesca',
    description: 'Equipamentos completos para pesca esportiva. Varas, molinetes, iscas, anzóis e todos os acessórios para uma pescaria de sucesso.',
    color: 'blue',
    filters: [
      {
        key: 'subcategory',
  ...
  caca: {
    slug: 'caca',
    title: 'Caça',
    description: 'Equipamentos especializados para caça esportiva. Roupas, acessórios, facas e equipamentos para caçadores licenciados.',
    color: 'green',
    warning: 'Equipamentos para caça esportiva licenciada. Respeite as leis ambientais e períodos de defeso.',
    warningTitle: 'Importante',
    warningType: 'info',
    filters: [
      {
  ...
  vestuario: {
    slug: 'vestuario',
    title: 'Vestuário',
    description: 'Roupas e acessórios táticos, outdoor e casuais. Camisetas, bonés, patches e muito mais para seu estilo.',
    color: 'gray',
    filters: [
      {
        key: 'subcategory',
  ...
  ofertas: {
    ...
    description: 'Aproveite as melhores ofertas em armas, equipamentos de pesca, caça, airsoft e muito mais. Descontos de até 50% por tempo limitado!',
    color: 'orange',
    filters: [
      {
        key: 'category',
