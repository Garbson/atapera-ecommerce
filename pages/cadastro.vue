  ...
  >
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 mt-2">Junte-se à comunidade Atapera</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" novalidate>
        <div class="space-y-6">
          ...
          <p v-if="errors.terms" class="text-sm text-red-600">
            {{ errors.terms }}
          </p>
...
// Head
useHead({
  title: "Cadastro - Atapera",
  meta: [{ name: "description", content: "Crie sua conta na Atapera" }],
});
...
const handleGoogleRegister = async () => {
  ...
  try {
    ...
    if (!result.success) {
      error.value = result.error || "Erro ao cadastrar com Google";
    }
